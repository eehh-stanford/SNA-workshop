...
In RStudio, create your own .R script file (File $\rightarrow$  New File $\rightarrow$ R Script). Type and save your code in the script file. To run a line of code, send it from the script to the console using `Ctrl+Enter` on your keyboard.
